...
/*
 * code from: https://github.com/IsaacChanghau/OptimizedImageEnhance/blob/master/src/main/java/com/isaac/estimate/AirlightEstimate.java
 */
  ...
  public static double[] estimate(Mat img, int blockSize) {
    ...
    for (int i = 0; i < img.rows(); i++) {
      for (int j = 0; j < img.cols(); j++) {
        ...
        double tmpValue = Math
            .sqrt(Math.pow(data[0] - 255.0, 2.0) + Math.pow(data[1] - 255.0, 2.0) + Math.pow(data[2] - 255.0, 2.0));
