...
/*
 * code from: https://github.com/IsaacChanghau/OptimizedImageEnhance/blob/master/src/main/java/com/isaac/models/RemoveBackScatter.java
 */
public class RemoveBackScatter {

  private static final int colorBalanceRatio = 5;

  public static Mat enhance(Mat image, int blkSize, int patchSize, double lambda, double gamma, int r, double eps,
      int level) {
